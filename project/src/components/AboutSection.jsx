...
const AboutSection = () => {
  ...
  const domains = [
    ...
    { icon: Shield, title: 'SECURE APPS', color: 'from-green-600 to-green-800', description: 'Create invulnerable software. Develop applications with a security-first approach.' }
  ];
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-16">
          <div className="about-content bg-gradient-to-br from-red-950/30 to-black/50 backdrop-blur-sm border-2 border-red-900/50 rounded-lg p-8" style={{ boxShadow: '0 0 30px rgba(220,38,38,0.2)' }}>
            <div className="flex items-center mb-4">
              ...
              <h3 className="text-2xl font-black text-white uppercase">Event Intel</h3>
            </div>
          ...
          <div className="about-content bg-gradient-to-br from-red-950/30 to-black/50 backdrop-blur-sm border-2 border-red-900/50 rounded-lg p-8" style={{ boxShadow: '0 0 30px rgba(220,38,38,0.2)' }}>
            <div className="flex items-center mb-4">
              ...
              <h3 className="text-2xl font-black text-white uppercase">Team Formation</h3>
            </div>
            <div className="space-y-3 text-gray-300">
          ...
          <div className="about-content bg-gradient-to-br from-red-950/30 to-black/50 backdrop-blur-sm border-2 border-red-900/50 rounded-lg p-8" style={{ boxShadow: '0 0 30px rgba(220,38,38,0.2)' }}>
            <div className="flex items-center mb-4">
              <Trophy className="w-8 h-8 text-red-500 mr-4" />
              <h3 className="text-2xl font-black text-white uppercase">Mission Objectives</h3>
            </div>
            <ul className="space-y-2 text-gray-300">
              <li className="flex items-start"><span className="text-red-500 mr-2">▸</span>Build innovative solutions in 24 hours</li>
              <li className="flex items-start"><span className="text-red-500 mr-2">▸</span>Collaborate with fellow innovators</li>
              <li className="flex items-start"><span className="text-red-500 mr-2">▸</span>Learn from industry mentors</li>
              <li className="flex items-start"><span className="text-red-500 mr-2">▸</span>Win prizes and internships</li>
            </ul>
          </div>
          ...
          <div className="about-content bg-gradient-to-br from-red-950/30 to-black/50 backdrop-blur-sm border-2 border-red-900/50 rounded-lg p-8" style={{ boxShadow: '0 0 30px rgba(220,38,38,0.2)' }}>
            <div className="flex items-center mb-4">
              ...
              <h3 className="text-2xl font-black text-white uppercase">Special Features</h3>
            </div>
            <ul className="space-y-2 text-gray-300">
              <li className="flex items-start"><span className="text-red-500 mr-2">▸</span>24/7 mentorship support</li>
              <li className="flex items-start"><span className="text-red-500 mr-2">▸</span>Tech workshops and sessions</li>
              <li className="flex items-start"><span className="text-red-500 mr-2">▸</span>Networking with industry leaders</li>
              <li className="flex items-start"><span className="text-red-500 mr-2">▸</span>Swag and refreshments</li>
            </ul>
          </div>
        </div>
        ...
        <div className="mb-12 md:mb-16">
          <h3
            ...
            style={{
              textShadow:
                '0 0 15px rgba(220,38,38,0.8), 0 0 25px rgba(220,38,38,0.6)',
            }}
          >
            Choose Your Battlefield
          </h3>
        ...
        <div ref={scrollContainerRef} className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6">
          {domains.map((domain, index) => {
            ...
            return (
              ...
              >
                <div
                  className={`absolute inset-0 bg-gradient-to-br ${domain.color} opacity-0 group-hover:opacity-20 transition-opacity duration-300`}
                ></div>
